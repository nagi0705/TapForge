...
export const translations = {
  ...
  zh: {
    ...
    hero: {
      ...
      subtitle: 'AI驱动的下一代名片',
      description: '加速您的业务',
      subDescription: '无需应用，月费免费。一次NFC轻触即可分享多语言个人资料。\n支持自由职业者获得海外项目。',
      cta: '申请免费试用',
      limited: '限50名！',
      features: {
        noApp: '无需应用',
  ...
  es: {
    ...
    hero: {
      ...
      subDescription: 'Sin aplicación requerida, mensualidad gratuita. Comparte perfiles multilingües con un toque NFC.\nApoyando a freelancers en la adquisición de proyectos en el extranjero.',
    ...
    problems: {
      ...
      problems: {
        ...
        followup: {
          ...
          description: 'Solo 15% de tasa de contacto después del intercambio de tarjetas'
        }
      },
      solutions: {
        ...
        time: {
          ...
          description: 'Fotografía de tarjeta de presentación con IA a conversión VCard'
        },
        language: {
          title: 'Soporte de 4 Idiomas',
          description: 'Japonés, Inglés, Chino, Español para negocios internacionales'
        },
        followup: {
