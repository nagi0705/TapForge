...
with open('/tmp/en-translations.txt', 'r', encoding='utf-8') as f:
    content = f.read()
...
# Save as temporary file for manual processing
with open('/tmp/en-partial.js', 'w', encoding='utf-8') as f:
    f.write(content)

print("Partial content saved. Need manual processing due to complex structure.")
...
print("✅ Created complete English translation file")